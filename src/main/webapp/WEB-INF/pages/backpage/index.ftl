...
<![endif]-->
<title>IMovie v1.0</title>
</head>
<body>
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">AMovie</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href=#">AMovie</a> <span class="logo navbar-slogan f-l mr-10 hidden-xs">v1.0</span> <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
			...
			<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
				<ul class="cl">
					...
					<li class="dropDown dropDown_hover"> <a href="#" class="dropDown_A">admin <i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							<li><a href="#">个人信息</a></li>
							<li><a href="${base.contextPath}/back/login">切换账户</a></li>
							<li><a href="${base.contextPath}/back/logout">退出</a></li>
						</ul>
					</li>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a _href="${base.contextPath}/order/select" data-title="查询订单" href="javascript:void(0)">查询订单</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a _href="${base.contextPath}/movie/select" data-title="电影列表" href="javascript:;">电影列表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a _href="/IMovie/admin/selectcinema" data-title="影院列表" href="javascript:void(0)">影院列表</a></li>
					<li><a _href="/IMovie/admin/selectback" data-title="已删除影院" href="javascript:void(0)">已删除影院</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-product">
			<dt><i class="Hui-iconfont">&#xe620;</i> 片场管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a _href="/IMovie/schedule/select" data-title="片场列表" href="javascript:void(0)">片场列表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-comments">
		...
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					<li><a _href="/IMovie/userManageAdminController/show" data-title="用户管理" href="javascript:void(0)">用户管理</a></li>
		...
		<dl id="menu-tongji">
			...
			<dd>
				<ul>
					<li><a _href="/IMovie/userManageAdminController/numshow" data-title="用户注册统计" href="javascript:void(0)">用户注册统计</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-system">
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active"><span title="我的桌面" data-href="welcome.ftl">我的桌面</span><em></em></li>
			</ul>
		</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="welcome.ftl"></iframe>
		</div>
	</div>
</section>
