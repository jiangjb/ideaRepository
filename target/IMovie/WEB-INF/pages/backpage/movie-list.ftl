...
<div class="page-container">
	...
	<a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" onclick="member_add('添加电影','/IMovie/pages/backpage/movie-add','','410')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加电影</a></span> <span class="r">共有数据：<strong>${mcount}</strong> 条</span> </div>
	<div class="mt-20">
