...
<![endif]-->
<title>爱.电影-删除影院</title>
</head>
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 影院管理 <span class="c-gray en">&gt;</span> 删除的影院<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
		<#list backcinema as back>
			<tr class="text-c">
				<td><input type="checkbox" value="1" name=""></td>
				<td>${back_index+1}</td>
				<td><u style="cursor:pointer" class="text-primary">${back.cinema_name}</u></td>
				<td>${back.cinema_vote}</td>
				<td>${back.cinema_sort}</td>
				<td>${back.city_name}</td>
				<td class="text-l">${back.cinema_addr}</td>
				<td>2016-12-5 11:11:42</td>
